...
#backgroundimg::before
{
    ...
    z-index: -1;
    opacity: 0.7;
    background: url('https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg?auto=compress&cs=tinysrgb&w=600') no-repeat center center/cover ;
}
...
<section id="backgroundimg">
  ...
  <div class="card-body mt-5">
    ...
    <form action="register" method="post" class="ms-5">

		<div class="mb-3 col-10">
			<label for="exampleInputName" class="form-label">name </label> <input
				type="text" name="exampleInputName" class="form-control"
		...
		<div class="mb-3 col-10">
			<label for="exampleInputUserName" class="form-label">user
				name</label> <input type="text" name="exampleInputUserName"
				class="form-control" id="exampleInputUserName" required>
		</div>

		<div class="mb-3 col-10">
			<label for="exampleInputPassword1" class="form-label">password</label>
			<input type="password" name="exampleInputPassword1"
				class="form-control" id="exampleInputPassword1" required>
		</div>

		<div class="mb-3 col-10">
			<label for="exampleInputContact" class="form-label">contact</label> <input
				type="text" name="exampleInputContact" class="form-control"
				id="exampleInputContact" required>
		</div>
	 <a href="login.jsp"><button class="btn me-5" type="submit">submit</button></a>
...
<div class="footer">
   ...
   if(status == "failed"){
	   swal("This email is already exist", "Try again", "warning");
	}
	</script> 
</body>
</html>